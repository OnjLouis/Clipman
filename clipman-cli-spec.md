...
5. **Interoperability fixture corpus** (section 14.1) — **started.** The
   ...
   generators are still missing because this machine has no Xcode, JDK, or
   reachable Mac. See <code>ClipmanCli/testdata/fixtures/README.md</code>.
...
<code>0.3.0-dev</code> and must be bumped together. Release tags use
<code>cli-v&lt;x.y.z&gt;-dev</code>.
