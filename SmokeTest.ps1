...
function Assert-HandoverParity([string]$releaseVersion) {
    ...
    Assert-TextMatches $handover 'Current 1\.5\.5 development context' 'Private handover current development context'
    ...
    Assert-TextDoesNotMatch $handover 'File history is session-only and held in RAM|Current public release: 1\.5\.1|Current development version: 1\.5\.1|Current development version: 1\.5\.4' 'Private handover stale facts'
