...
function Assert-HandoverParity([string]$releaseVersion) {
    ...
    Assert-TextMatches $handover 'Current 1\.5\.6 development context' 'Private handover current development context'
    ...
    Assert-TextMatches $handover 'Shift\+Enter goes to a single selected file or folder' 'Private handover file-history go-to-file context'
    Assert-TextDoesNotMatch $handover 'File history is session-only and held in RAM|Current public release: 1\.5\.1|Current development version: 1\.5\.1|Current development version: 1\.5\.4|Current development version: 1\.5\.5' 'Private handover stale facts'
...
function Assert-ManualAndReadmeClean {
    ...
    Assert-TextMatches $manual 'Go to file with <code>Shift\+Enter</code>' 'Manual 1.5.5 go-to-file changelog'
    ...
    Assert-TextMatches $readme 'Shift\+Enter` to open Explorer' 'README file-history go-to-file documentation'
